...
#first game 
if first[1] == 'Dark':
    message = f"{date}: our first game we are playing against {dictionary[first[0][3]]} wearing {first[1]} on {first[0][1]}. "

else:   
    message = f"{date}: our first game we are playing against {dictionary[first[0][5]]} wearing {first[1]} on {first[0][1]}. "
